...
job_mapping = {
 ...
 # 'Build a alu-rp RPM for ALU-RP 9.2' => { :job => 'Build a alu-rp RPM for ALU-RP 9.2'},
 # 'Build a xtrabackup RPM for ALU-RP 9.2' => { :job => 'Build a xtrabackup RPM for ALU-RP 9.2'},
  'naf-9.1-next-coverage' => { :job => 'naf-9.1-next-coverage'},
